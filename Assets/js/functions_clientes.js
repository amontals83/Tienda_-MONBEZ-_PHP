let tableClientes;
//rowTable para mantenerse en la misma pagina de la tabla cuando se realizan cambios en un elemento en vez de volver a la pagina 1
let rowTable = "";
...
document.addEventListener('DOMContentLoaded', function()
{
    ...
    //Creacion o actualizacion de un registro
        ...
        formCliente.onsubmit = function(e) {
            ...
            request.onreadystatechange = function(){
                if(request.readyState == 4 && request.status == 200){
                    ...
                    {
                        if(rowTable == ""){
                            //Si esta vacio refrescamos el datatable
                            tableClientes.api().ajax.reload();
                        }else{
                            //Si no esta vacio actualizamos el datatable

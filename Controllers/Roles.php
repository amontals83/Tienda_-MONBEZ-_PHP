...
class Roles extends Controllers
{
	...
	//Version sin los permisos SESSION
	...
	// 		{
	// 			$arrData[$i]['status'] = '<span class="badge badge-primary">Activo</span>';
	// 		}else{
	// 			$arrData[$i]['status'] = '<span class="badge badge-danger">Inactivo</span>';
	// 		}

	// 		$arrData[$i]['options'] = '<div class="text-center">
	// 		<button class="btn btn-primary active btn-sm btnPermisosRol" onClick="fntPermisos('.$arrData[$i]['idrol'].')" title="Permisos"><i class="fas fa-key"></i></button>
		...
		if($_SESSION['permisosMod']['r'])
		{
			...
			for ($i=0; $i < count($arrData); $i++) {
				...
				if($_SESSION['permisosMod']['u']){
					$btnView = '<button class="btn btn-primary active btn-sm btnPermisosRol" onClick="fntPermisos('.$arrData[$i]['idrol'].')" title="Permisos"><i class="fas fa-key"></i></button>';
